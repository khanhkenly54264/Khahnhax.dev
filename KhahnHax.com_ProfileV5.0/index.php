...
<?php 
$KhahnHaxHeader = new KhahnHaxHeader();
$KhahnHaxLoveDays = new KhahnHaxLoveDays();
$KhahnHaxMusicList = new KhahnHaxMusicList();
$KhahnHaxHeader->CommonMethod();
$KhahnHaxLoveDays->CommonMethod();
$KhahnHaxMusicList->CommonMethod();
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="<?=$KhahnHaxHeader->description?>">
    <meta name="author" content="KhahnHax.com">
    <meta name="keywords"
        content="<?=$KhahnHaxHeader->keywords?>">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <link rel="shortcut icon" href="<?=$KhahnHaxHeader->favicon?>?v=<?=rand(1,999)?>" type="image/x-icon">
    <meta property="og:title" content="<?=$KhahnHaxHeader->title?>">
    <meta property="og:url" content="//KhahnHax.com">
    <meta property="og:image" content="./res/v5/img/bg3.webp">
    <title><?=$KhahnHaxHeader->title?></title>
    <!--/ @StyleSheets /-->
    ...
    <link rel="stylesheet" href="//cdn.KhahnHax.com/dialog/wstoast/ws.toast.css?v=1">
</head>
<body class="BodyStyle">
    ...
    <div id="loading-box">
        <div class="loading-bg">
            <img class="loading-img entered loading" src="<?=$KhahnHaxHeader->favicon?>?v=<?=rand(1,999)?>" data-ws-status="loading">
    ...
    <main id="td-main">
            ...
            <div class="td-popup" id="share_card">
                <div class="left">
                    ...
                    <div class="button mt-2">
                        ...
                        <span class="td-btn"
                            onclick="window.open('https://www.messenger.com/t/' + encodeURIComponent('KhahnHax'),'top');"
        ...
        <header id="header">
            <h2>
                <a href="#" class="site-icon"><?=$KhahnHaxHeader->namesite?></a>
            </h2>
        ...
        <section class="td-content">
            <div class="about-me">
                <div class="info-left">
                    <span class="tag"><?=$KhahnHaxHeader->bio1?></span>
                    <span class="tag"><?=$KhahnHaxHeader->bio2?></span>
                    <span class="tag"><?=$KhahnHaxHeader->bio3?></span>
                </div>
                <div class="avatar">
                    <img class="avatar-img" src="<?=$KhahnHaxHeader->avatar?>?v=<?=rand(1,999)?>" alt="Vương Thanh Diệu">
                    <img class="crown" src="./res/v5/img/crown/mong-vuot-rong.png">
                    <!-- <img class="crown2" src="./res/v5/img/crown/vip-crown.png"> -->
                </div>
                <div class="info-right">
                    <span class="tag"><?=$KhahnHaxHeader->bio4?></span>
                    <span class="tag"><?=$KhahnHaxHeader->bio5?></span>
                    <span class="tag"><?=$KhahnHaxHeader->bio6?></span>
                </div>
            </div>
            <div class="padding" style="height:2em;"></div>
            <h2 class="HoVaTen__">
                <span id="userName" data-userName='<?= json_encode($KhahnHaxHeader->userName ?? []) ?>'></span>
            </h2>
            <div class="about-me-2">
                <button class="trigger"><?=$KhahnHaxHeader->trigger?></button>
                <button class="trigger"><?=$KhahnHaxHeader->bio1?></button>
                <button class="trigger"><?=$KhahnHaxHeader->bio2?></button>
                <button class="trigger"><?=$KhahnHaxHeader->bio3?></button>
                <button class="trigger"><?=$KhahnHaxHeader->bio4?></button>
                <button class="trigger"><?=$KhahnHaxHeader->bio5?></button>
                <button class="trigger"><?=$KhahnHaxHeader->bio6?></button>
            </div>
            <div class="padding" style="height:1em;"></div>
            <section id="hr-mod">
                <?php foreach ($KhahnHaxHeader->SocialNetworks as $network => $url): ?>
    ...
    <div class="padding" style="height:4em;"></div>
        <div class="love-time1 mt-5">
            <div class="hide" data-ngayyeu="<?= $KhahnHaxLoveDays->ConfigLove['time_relashiption']; ?>"></div>
        ...
        <div class="bg-wrap central mt-5">
            <div class="bg-img">
                <div class="middle animated">
                    <div class="img-male">
                        <img src="<?=$KhahnHaxLoveDays->ConfigLove['avatar_male'];?>"
                            alt="<?=$KhahnHaxLoveDays->ConfigLove['name_male'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$KhahnHaxLoveDays->ConfigLove['name_male'];?></span>
                    </div>
                    <div class="heart"></div>
                    <div class="img-female">
                        <img src="<?=$KhahnHaxLoveDays->ConfigLove['avatar_female'];?>"
                            alt="<?=$KhahnHaxLoveDays->ConfigLove['name_female'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$KhahnHaxLoveDays->ConfigLove['name_female'];?></span>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="nk-opt-set nk-opt-set-aside-apps change-bg">
                                    ...
                                    <div class="nk-opt-list col-4x">
                                        ...
                                        <div class="nk-opt-item"
                                            data-bg="https://api.KhahnHax.com/random-background.php">
                                            <span class="nk-opt-item-bg">
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        <?php foreach ($KhahnHaxMusicList->songs as $song): ?>
                                        <li url="<?= $song['url'] ?>">
                                            <span class="name">
    ...
    <footer id="footer">
        <span>
            <a href="//KhahnHax.com" target="_blank">&copy; Copyright&nbsp;KhahnHax 2024</a>
        </span>
    </footer>
    ...
    <script src="//cdn.KhahnHax.com/dialog/wstoast/ws.toast.js"></script>
